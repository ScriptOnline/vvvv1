...
print ('''
            ...
            ╚═════╝░╚═╝░░░░░╚═╝░░╚═╝╚═╝░░░░░╚═╝╚═════╝░╚═╝░░░░░╚═╝╚═════╝░
                        ...
                        [ > SPAM SMS BY 𝖅-𝕹𝖎𝖌𝖍𝖙𝕾𝖍𝖔𝖙#9561 < ]
                        
                  [+] | FACEBOOK : Apiwat Monkom
                  [+] | YOUTUBE  : Z-NightShot
                  [+] | Discord  : 𝖅-𝕹𝖎𝖌𝖍𝖙𝕾𝖍𝖔𝖙#9561
                  [+] | Number : ห้ามเกิน1000นะจะ     
...
print ("")
time.sleep(1)
phone = input("\033[1;91mPHONE-NUMBER \033[1;93m: \033[1;92m")
time.sleep(1)
jam = int(input("\033[1;91mOTP \033[1;93m: \033[1;92m"))
print("")
...
def api1():
	...
	print(f"\033[1;96m[\033[1;91m+\033[1;96m] \033[1;96m{phone} \033[1;93mส่งOTP \033[1;91m" + str(random.randint(1000,9999)))
...
if (jam < 1001):
	...
	print("\033[1;91m ไม่เกิน1000ไอ้เวร") 
	time.sleep(1)
	os.system("python 20api.py")